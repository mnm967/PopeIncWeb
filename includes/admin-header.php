<?php
    ...
    include("includes/classes/AdminConstants.php");
            ...
            <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu header-dropdown-menu">
                        <a class="text-black dropdown-item display-4" href="admin-clothing.php?type=clothing&s=men" aria-expanded="false">Clothing</a>
                        <a class="text-black dropdown-item display-4" href="admin-clothing.php?type=shoes&s=men" aria-expanded="false">Shoes</a>
                        <a class="text-black dropdown-item display-4" href="admin-clothing.php?type=accessories&s=all" aria-expanded="false">Accessories</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link link text-black dropdown-toggle display-4" aria-expanded="false" data-toggle="dropdown-submenu">Women</a>
                    <div class="dropdown-menu header-dropdown-menu">
                        <a class="text-black dropdown-item display-4" href="admin-clothing.php?type=clothing&s=women" aria-expanded="false">Clothing</a>
                        <a class="text-black dropdown-item display-4" href="admin-clothing.php?type=shoes&s=women" aria-expanded="false">Shoes</a>
                        <a class="text-black dropdown-item display-4" href="admin-clothing.php?type=accessories&s=all" aria-expanded="false">Accessories</a>
                    </div>
                </li>
            </ul>
            <div class="navbar-buttons mbr-section-btn">
                <a class="btn btn-sm btn-black display-4" href="admin-search.php">
